...
export const EN = {
  ...
  'task.editor.title': 'Task',
  'task.rules': 'Rules',
  'task.length': 'Task length',
  'task.none': 'No task declared',
  'task.clear': 'clear',
  'task.up': '↑',
  'task.down': '↓',
  'task.remove': 'remove',
  'task.role.start': 'start',
  'task.role.turn': 'turn',
  'task.role.finish': 'finish',
  'task.search': 'search a waypoint…',
  'task.noPoints': 'No waypoint file loaded. A task is built from points — load a .cup in Settings.',
  'task.more': '…and {n} more. Type a few more letters.',
  'task.problem.tooShort': 'One point is not a task. Add at least a start and a finish.',
  'task.problem.zeroLeg': '{from} → {to} is a leg with no length, and a leg with no length has no course. A start gate has nothing to stand across.',
